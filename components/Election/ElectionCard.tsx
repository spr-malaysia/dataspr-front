            ...
            <div className="flex min-h-full items-center justify-center p-2 text-center">
              ...
              >
                <Dialog.Panel
                  className={clx(
                    body.variable,
                    "border-slate-200 dark:border-zinc-700 shadow-floating w-full max-w-4xl transform rounded-xl border bg-white p-6 text-left align-middle font-sans transition-all dark:bg-zinc-900"
                  )}
                >
                  <button
                    className="hover:bg-slate-100 dark:hover:bg-zinc-800 group absolute right-4 top-[22px] h-8 w-8 rounded-full"
