...
const ActiveState: FunctionComponent = () => {
  ...
  return (
    <div className="relative flex h-full max-h-[90vh] w-full grow flex-col justify-between pb-6 dark:bg-zinc-900">
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-8 py-6">
              ...
              <ul className="flex flex-col gap-3 text-sm">
                {descriptions.map(description => {
                  return (
                    <li
                      key={description}
                      className="bg-slate-100 dark:bg-[#121212] text-slate-800 dark:text-zinc-500 rounded-md p-3"
                    >
                      {description}
                    </li>
                  );
      ...
      <div className={clx("flex flex-col gap-2")}>
        <p className="text-zinc-500 space-x-2 text-center text-xs">
        ...
        <p
          className={clx(
            "bg-slate-100 dark:bg-[#121212] text-slate-800  dark:text-zinc-500 rounded-md p-3 text-xs",
            show ? "block" : "hidden"
          )}
        >
