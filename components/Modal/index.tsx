            ...
            <div className="fixed inset-0 flex items-end justify-center lg:items-center">
              ...
              >
                ...
                >
                  ...
                  <div className="dark:border-zinc-800 relative flex w-full items-center justify-between rounded-t-xl border bg-white p-3 dark:bg-zinc-900">
                    <Dialog.Title as="div" className="mr-9 flex grow">
                      {title}
                    </Dialog.Title>
                    <Button
                      variant="ghost"
                      className="hover:bg-slate-100 dark:hover:bg-zinc-800 group absolute right-3 rounded-full p-0"
