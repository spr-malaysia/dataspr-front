...
import { CodeBlock, Dropdown, Modal, ModalInterface, Panel, Tabs } from "@components/index";
  ...
  ({ uid, options, defaultOption, translations }, ref) => {
    ...
    return (
      <Modal ref={modalRef} title={<h4>{t("embed")}</h4>} className="lg:max-w-screen-xl">
        {() => (
          <div className="grid w-full grid-cols-1 bg-white dark:bg-zinc-900 lg:grid-cols-3 lg:rounded-b-xl">
            <div className="col-span-2 hidden bg-slate-50px-6 py-3 dark:bg-zinc-900 lg:block lg:rounded-bl-xl">
